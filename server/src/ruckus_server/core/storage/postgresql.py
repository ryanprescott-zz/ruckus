...
from .base import StorageBackend, Base, Agent, Experiment
...
class PostgreSQLStorageBackend(StorageBackend):
    ...
    async def remove_queued_job(self, agent_id: str, job_id: str):
        ...
        if hasattr(self, '_queued_jobs') and agent_id in self._queued_jobs:
            self._queued_jobs[agent_id] = [
    ...
    async def get_completed_jobs(self, agent_id: str):
        ...
        return getattr(self, '_completed_jobs', {}).get(agent_id, [])
