                ...
                <div className="task-parameters">
                  <div className="form-field">
                    ...
                    <input
                      id="task-name"
                      type="text"
                      value={isCreatingNew ? newExperiment?.task.name || '' : selectedExperiment?.task.name || ''}
                      onChange={(e) => {
                        if (isCreatingNew && newExperiment) {
                          setNewExperiment({
                            ...newExperiment,
                            task: { ...newExperiment.task, name: e.target.value }
                          });
                        }
                      }}
                      readOnly={!isCreatingNew}
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        if (isCreatingNew && newExperiment) {
                          setNewExperiment({
                            ...newExperiment,
                            task: { ...newExperiment.task, type: e.target.value as TaskType }
                          });
                        }
                      }}
                      disabled={!isCreatingNew}
                  ...
                  <div className="params-section">
                    <h4>Params</h4>
                    <div className="params-placeholder">Coming Soon</div>
                  </div>
                </div>
              )}
